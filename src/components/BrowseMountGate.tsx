 ...
 * Remount is deferred until idle so sync hls teardown and the close paint finish first —
 * remount + hls.destroy on the same tick freezes TV, mobile, and desktop browsers.
 */
