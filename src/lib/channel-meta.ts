...
const COUNTRY_TABLE: Array<{
  ...
  { codes: ["BOSNIA", "BIH", "BOS"], flag: "🇧🇦", name: "Bosnia", iso2: "BA" },
  { codes: ["CROATIA", "CRO", "HRV"], flag: "🇭🇷", name: "Croatia", iso2: "HR" },
  { codes: ["SERBIA", "SRB", "SER"], flag: "🇷🇸", name: "Serbia", iso2: "RS" },
  {
    codes: ["MACEDONIA", "NORTH MACEDONIA", "MKD"],
    flag: "🇲🇰",
    name: "North Macedonia",
    iso2: "MK",
  },
  { codes: ["SLOVENIA", "SVN"], flag: "🇸🇮", name: "Slovenia", iso2: "SI" },
  { codes: ["MONTENEGRO", "MNE"], flag: "🇲🇪", name: "Montenegro", iso2: "ME" },
  { codes: ["BULGARIA", "BGR"], flag: "🇧🇬", name: "Bulgaria", iso2: "BG" },
  { codes: ["ALBANIA", "ALB"], flag: "🇦🇱", name: "Albania", iso2: "AL" },
  { codes: ["KOSOVO"], flag: "🇽🇰", name: "Kosovo", iso2: "XK" },
  { codes: ["SWEDEN", "SWE"], flag: "🇸🇪", name: "Sweden", iso2: "SE" },
  { codes: ["NORWAY", "NOR"], flag: "🇳🇴", name: "Norway", iso2: "NO" },
  { codes: ["DENMARK", "DEN"], flag: "🇩🇰", name: "Denmark", iso2: "DK" },
  { codes: ["FINLAND", "FIN"], flag: "🇫🇮", name: "Finland", iso2: "FI" },
  { codes: ["HUNGARY", "HUN"], flag: "🇭🇺", name: "Hungary", iso2: "HU" },
  { codes: ["SLOVAKIA", "SVK"], flag: "🇸🇰", name: "Slovakia", iso2: "SK" },
  { codes: ["CZECH", "CZECHIA", "CZE"], flag: "🇨🇿", name: "Czechia", iso2: "CZ" },
